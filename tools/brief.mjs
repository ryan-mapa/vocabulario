...
p('9. **Vary the sentence shape.** No more than a quarter may open the same way.');
p('   A run of `El X es Y.` is rejected even when every sentence is correct.');
p('10. **No names, and no he/she where a neutral subject will do.** A sentence');
